...
def step_3_validation(response3):               #
    ...
    try:                                        #
        ...
        msg = "Pls indicate the correct index"  #
        return validation.reply(msg)            ## This will change base on whether we can do button or not
